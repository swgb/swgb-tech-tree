...
const CivDescription = (props) => {
  if (props.civ == "10272") {
      return(
        ...
        <b>Fortress Bonus</b>: Fortresses build 10% faster.
        <b>Unique Unit</b>: Dark Trooper(Trooper) and Probot(Scout)<br/>
        <b>Unique Technologies</b>: Walker Research, Chain lightning, Altered Bargains<br/>
        <b>Team Bonus</b>: Mech factory work 10% faster.
         </span>)
  }
  if (props.civ == "10271") {
      return(
        ...
        <b>Unique Technologies</b>: Tougher Armor (War Center); Plasma Detonators (Troop Center); A-Wing Research (Airbase); Evacuation Protocols (Research Center)<br/>
  ...
  if (props.civ == "10273") {
    return(
        <span><b>Strong units</b>: Mech and Ships.<br/>
      <b>Civilization Bonus</b>: Prefab Shelters are not necessary. Troop Center units cost -5/20/35% in Tech Level 2/3/4.<br/>
      <b>Civilization weakness:</b> Carbon collection is 10% slower. Starts with -25 less Carbon. Aircraft take 5% longer to build and are 5% more expensive.<br/>
      <b>Fortress Bonus</b>: Fortresses' anti-air attack has +3 LoS, Search Radius, and Range.<br/>
      <b>Unique Unit</b>: Destroyer Droid (Mech)<br/>
  ...
  if (props.civ == "10274") {
    return(
      ...
      <b>Unique Technologies</b>: Air Cruiser Boost(Airbase); Kaminoan Refit (Animal Nursery); Upgraded Med Droids (Command Ctr); Gal Senate Hub (Fortress); Sight Beyond Sight (Jedi Temple); Gunship Armaments (Airbase); Kaminoan Cloners (War Ctr)<br/>
  ...
  if (props.civ == "10281") {
    ...
    <b>Civilization Bonus</b>: Airbase technologies cost 20% less. Airbase military units move 5% faster.  Workers move 10% faster; conduct repairs 2x faster. A nova stockpile (400 Nova) is created at every newly built Command Center.<br/>
    Temple units cost 12% less Nova (hidden bonus).* Hvy Mech upgrades cost 10% less (hidden bonus, possibly bug).*<br/>
    ...
    <b>Team Bonus</b>: Scouts and Fighters gain +1 LoS, Spaceports work 25% faster.<br/>
    </span>)
  }
  ...
  if (props.civ == "10275") {
    ...
    <b>Team Bonus</b>: Cargo Hovercraft generates +25% Nova crystals.<br/>
    </span>)
  }

  if (props.civ == "10282") {
    return(<span><b>Strong units</b>: Mounted Troopers and Heavy Weapons<br/>
    <b>Civilization bonus</b>: Workers gain Basic Training automatically; Preadtors can be produced at the Animal Nursery; Workers build 10% faster; Basic Armor, Light Armor, Hvy Armor free; requires War Center. Hvy Mech upgrades cost 10% less (hidden bonus, possibly bug).*<br/>
    <b>Fortress Bonus</b>: Fortresses have +5 Garrison Capacity and provide +5 Population Space.<br/>
    <b>Unique Unit</b>: Geonosian Warrior (Air Unit), Controllable Predators (Mounted Trooper)<br/>
    ...
    <b>Team bonus</b>: Unique units 10% cheaper.<br/>
    </span>)
  }
  ...
  if (props.civ == "10280") {
    return(<span>
      ...
      <b>Civilization bonus</b>: Workers carry +3 resources. Advancing tech levels require one fewer building. Troop Center technologies cost 25% less. Hvy Mech upgrades cost 10% less (Hidden bonus, possibly bug). Flametroopers move slower than Mounted Troopers. <br/>
      <b>Fortress Bonus</b>: Forts attack 10% faster.<br/>
      <b>Unique Unit</b>: Jet Trooper (Trooper)<br/>
  ...
  if (props.civ == "10276") {
    ...
    <b>Civilization bonus</b>: Gungans can build Prefab Shelters underwater. Buildings have self-regeneration(except Power Core, Monument, Anti-Air Battery, Mine, Walls, Gate, Farm, and AquaHarvester).<br/>. Workers have a +10% Ore Mining Bonus in TL-3. Military ships are detectors.<br/>
    <b>Civilization weakness</b>: Aircraft take 5% longer to build and are 5% more expensive.<br/>
  ...
  if (props.civ == "10278") {
    ...
    <b>Civilization bonus</b>: War Center upgrades cost -15%; Hvy Weapons attack 10% faster; Bounty Hunters have +1 +1 LoS, Search Radius, and Range. Hvy Mech upgrades cost 10% less (hidden bonus, possibly bug).*<br/>
    <b>Fortress bonus</b>: Every standing fortress reduces nova cost of Fortress units by 5%.<br/>
    <b>Unique Units</b>: Defiler (Grenade Trooper); Vornskr (Mounted Trooper)<br/>
    <b>Unique Technologies</b>: Black Market Components (War Center); Piracy (Spaceport); Phased Pulse Cannons (Mech Factory)<br/>
    <b>Team bonus</b>: Hvy Weapon Factories work 10% faster.<br/>
    </span>)
  }
